...
const uint8_t Letter[13] = {
  0b01110111,  // this means A
  0b01111100,  // this means b
  0b01011000,  // this means c
  0b01011110,  // this means d
  0b01111001,  // this means E
  0b01010100,  // this means n
  0b01011100,  // this means o
  0b01110011,  // this means P
  0b01010000,  // this means r
  0b01101101,  // this means S
  0b01111000,  // this means t
  0b00011100,  // this means u
  0b00000000,  // this means <empty>
};
